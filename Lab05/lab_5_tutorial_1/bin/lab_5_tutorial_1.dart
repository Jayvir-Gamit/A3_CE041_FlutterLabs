...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'vaidik',
    'deep'
  ]; //This is same as , final desserts = const['jayvir','daidik','deep'];
  // Below 3 will not work because list is const
  // desserts.add('dhiren');
  // desserts.remove('deep');
  // desserts[0] = 'abc';
  ...
  */
  ...
  // Tear-off property
  drinks.forEach(print); // And since the input of print is the same as the output of the forEach function, Dart allows you to rephrase that.
  */
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'jayvir');
  User user2 = User(2, 'vaidik');
  User user3 = User(3, 'deep');
